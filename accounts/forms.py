...
class SignUpForm(UserCreationForm):
    first_name = forms.CharField(max_length=30, required=False, help_text='Zorunlu değil.')
    last_name = forms.CharField(max_length=30, required=False, help_text='Zorunlu değil.')
    email = forms.EmailField(max_length=254, help_text='Gerekli. Lütfen geçerli bir e-posta adresi girin.')
